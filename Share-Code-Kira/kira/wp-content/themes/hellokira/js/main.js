	...
	$(document).ready(function() {
		$('.open-project').on('click', function(){     
			...
			$.ajax({
	            ...
	            data: {
	                'action' : 'Load_action', id : id 
	            },
	            beforeSend: function () {
	            	$('.modal-content').html('<section class="content"><div class="block-content"><p class="loadaj"><img src="http://hstatic.net/826/1000024826/1000056151/load.gif" /><p></div></div>');
	            },
	            complete: function(){
	            },
